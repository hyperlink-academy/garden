...
export const RoomListItem = (props: {
  ...
  return (
    <div
      className={`relative select-none rounded-md border  ${isActiveRoom || props.isOver
    ...
    >
      ...
      <button
        ...
        className={`sidebarRoom flex w-full flex-row gap-1 py-0.5 pl-1 pr-0.5 text-left ${isActiveRoom ? "font-bold" : ""
          }`}
        onClick={(e) => {
